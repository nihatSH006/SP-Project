 ...
 * The SOCAR wordmark.
 *
 * The flame keeps its three brand colours as literal fills — those are the
 * mark and must not drift with the theme. The lettering is `currentColor`
 * instead of the black it ships as, so it inherits the surrounding text colour
 * and reads white on the dark board without a second copy of the asset.
 *
 * The clip path in the original file spans a 926px-tall canvas against a 119px
...
export function SocarLogo({
  ...
  return (
    ...
    >
      <path
        fill="#ef3340"
        d="M29.85,17.81c0,31.42 -26.32,37.3 -26.32,67.5c0,11.79 7.43,22 16.2,23.22c-0.64,-2.15 -0.85,-3.81 -0.85,-6.13c0,-21.8 35.04,-28.56 35.04,-65.74c0,-17.78 -12.54,-32.81 -27.17,-36.38c0,0 3.09,9.65 3.09,17.52z"
      />
      <path
        fill="#509e2f"
        d="M27.63,103.72c0,6.17 4.37,12.74 10.07,14.88c-0.3,-0.91 -0.44,-1.71 -0.44,-3.05c0,-12.15 35.94,-16.02 35.94,-47.77c0,-8.78 -3.67,-18.31 -10.94,-24.56c-4.92,36.09 -34.63,41.06 -34.63,60.5z"
      />
      <path
        fill="#00b5e2"
