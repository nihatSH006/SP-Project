...
export const ru: Dictionary = {
  ...
  alerts: {
    ...
    liveFeedEmpty: "Пока пусто — включите ленту, события появятся здесь.",
    liveFeedError: "сбой запроса",
    liveFeedLastCheck: "проверено",
    types: {
  ...
  workers: {
    ...
    timelineDesc:
      "Сверху: присутствие, ровно как говорят отметки. Ниже: продажи, собранные в 15-минутные столбцы, цвет — по преобладающему топливу (наведите для цифр); красные метки — продажи вне полосы присутствия.",
